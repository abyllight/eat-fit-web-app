    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.courier.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="car_number" type="text" class="form-control @error('car_number') is-invalid @enderror" name="car_number" value="{{ old('car_number') }}" autocomplete="car_number">
